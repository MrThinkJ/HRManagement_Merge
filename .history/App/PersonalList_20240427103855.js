      ...
      new DataTable(".table-1",{
        ...
        columns: [
            ...
            { 'data': null, title: 'Action', wrap: true, "render": function (item) {
              return '<div class="btn-group"> <button type="button" onclick="location.href="./Edit.html"" class="btn btn-warning">Edit</button><button type="button" onclick=""" class="btn btn-warning">Delete</button></div>' }},
          ],
        searching: true,
        "bDestroy": true,
      });
