const socket = new WebSocket("ws://localhost:8080/api/middleware");
...
socket.onopen = function () {
  socket.subscribe("/topic/public"); // Subscribe to the topic
};
...
//   var socket = new SockJS('http://localhost:8080/middleware');
