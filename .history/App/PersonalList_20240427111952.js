      ...
      new DataTable(".table-1",{
        ...
        columns: [
            ...
            { 'data': null, "render": function (data) {
              ...
              return `<div class='btn-group'> <button type='button' onclick=location.href='./Edit.html' class='btn btn-success'>Edit</button><button type='button' onclick=deleteEmployee(${data.firstName}, ${data.lastName}) class='btn btn-danger btn-delete'>Delete</button></div>` }},
          ],
        searching: true,
        "bDestroy": true,
      });
